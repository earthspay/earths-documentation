...
Вы можете совершить Массовую отправку токенов из своего Earths аккаунта. С помощью этой функции вы можете отправить Earths или любой другой Ассет из своего аккаунта на несколько (до 100) Earths адресов.

Для этого откройте свой Earths кошелёк и во вкладке **Портфель** нажмите на кнопку Отправить в конце строки Ассета.
...
**Адрес, Сумма**: введите построчно Earths адреса получателей и через запятую сумму отправки;
...
**Комиссия**: в этом поле отобразиться комиссия за Массовую отправку токенов из расчета: 0,001 Earths + 0,0005 Earths x количество адресов.
...
Также вы можете импортировать файл с Earths адресами получателей и суммами.
