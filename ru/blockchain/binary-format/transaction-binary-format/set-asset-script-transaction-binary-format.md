...
| 6 | ID токена | assetId | Array[[Byte](/blockchain/blockchain/blockchain-data-types.md)] | 32 | ID токена, на который должен быть установлен новый скрипт  |
...
| 10 | Длина скрипта |  | [Short](/blockchain/blockchain/blockchain-data-types.md) | S | S = 0 если значение поля 9 равно 0.S = 2 если значение поля 9 равно 1 |
| 11 | Скрипт | script | Array[[Byte](/blockchain/blockchain/blockchain-data-types.md)] | S | S = 0 если значение поля 9 равно 0.1 <= S <= 32768 если значение поля 9 равно 1 |
