...
| 6 | [Адрес](/blockchain/address.md) или [псевдоним](/blockchain/alias.md) | dApp | Array[[Byte](/blockchain/blockchain/blockchain-data-types.md)] | 26 | [Адрес](/blockchain/address.md) или [псевдоним](/blockchain/alias.md) dApp, скрипт которого должен быть вызван |
