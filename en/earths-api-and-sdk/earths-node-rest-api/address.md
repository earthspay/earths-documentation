...
```
"address" - account's address in Base58 format
"Regular" — that's how much Earths you have, including those you leased;
"Available" — the same as regular only without Earths you leased;
"Effective" — available plus those Earths which is leased to you;
