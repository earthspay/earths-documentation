...
In the new version, the transactions are signed by [_**proofs**_](/earths-environment/earths-protocol/versioned-transactions.md) instead of using a signature.
