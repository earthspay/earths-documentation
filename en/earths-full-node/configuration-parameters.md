# Earths Node Configuration Parameters
...
Complete default Earths Node configuration file which is embedded into jar-file can be found here: https://github.com/earthspay/Earths/blob/master/src/main/resources/application.conf
...
* https://github.com/earthspay/Earths/blob/master/earths-mainnet.conf
* https://github.com/earthspay/Earths/blob/master/earths-testnet.conf

### Overriding parameters when running JAR-file

If you run JAR file it's recommended to override default parameters by passing a path to config file as the command line parameter then starting Earths Node application.

```java -jar earths-all-0.13.3.jar earths.conf```

Typically this file should contain you node's unique characteristics (ip, name, keys, etc...) and network-specific parameters similar to earths-mainnet or earths-testnet configs from previous sections (files shipped with DEB packages).
