...
To build and test your Earths Node, you will need to follow these steps:
...
You can replace earths-all\*.jar with actual jar name \(it should have "all"-word\):

```
java -jar target/earths-all*.jar path/to/config/file
```
