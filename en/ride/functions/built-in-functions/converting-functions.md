...
| 2 | [addressFromRecipient(Address&#124;Alias): Address](#address-from-recipient) | Gets the corresponding [address](/blockchain/address.md) of the [alias](/blockchain/account/alias.md) | 100 |
...
Gets the corresponding [address](/blockchain/address.md) of the [alias](/blockchain/account/alias.md).
