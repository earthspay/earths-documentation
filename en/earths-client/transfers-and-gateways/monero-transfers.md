...
Please note that the gateway charges **0.01 XMR** for the gateway fee as well as **0.001 Earths** for the network fee.
...
You can send Monero directly to another Earths account. Just use the recipient **Earths** address, click on the **Send** and fill-in the sending form.
