...
Earths allow you to hold and transfer Bitcoin SV on its blockchain. This works through a so-called Multigateway approach: Bitcoins Cash are sent to a user's deposit address available in the Earths wallet and after the deposit the user receives a Bitcoin SV token \(wBSV\) issued in the Earths blockchain. Every single Bitcoin SV token is backed 1:1 with the real Bitcoin SV.
...
Please note that the gateway charges **0.01 BSV** for the gateway fee as well as **0.001 Earths** for the network fee.
...
## How to transfer Bitcoin SV to another Earths account

You can send Bitcoin SV directly to another Earths account. Just use the recipient **Earths** address, click on the **Send** and fill-in the sending form.
