...
Here we present a standard that allows the exchange of information about tokens between data providers and applications using the Earths blockchain.

Any company or individual provider can provide information about tokens, verify/certify projects that have issued a token in the Earths blockchain. Any application using the Earths blockchain can use the information provided by the providers.
...
Each provider has its own Earths address. It can be created specially for the purpose of asset verification or used for other goals as well. 

![](/_assets/earths_ticker_1.png)
