...
Please note that the gateway charges 0.001 BTC for the gateway fee as well as 0.001 Earths for the network fee. Read the conditions carefully in yellow boxes before proceeding.
...
You can send Bitcoins directly to another Earths account, just use the recipient Earths address, click on Send and fill-in the sending form.
