...
| field	| [IssueTransaction](https://docs.earths.ga/earths-client/assets-management/issue-an-asset.html) |	[ReissueTransaction](https://docs.earths.ga/earths-client/assets-management/issue-an-asset.html)	| [BurnTransaction](https://docs.earths.ga/earths-client/assets-management/burn-an-asset.html) |
| ------------- | ------------- | ------------- | ------------- |
| quantity	| + |	+	| + |
| name	| +	| | | 
| description |	+ |		| |
...
| field | TransferTransaction	| [MassTransferTransaction](https://docs.earths.ga/technical-details/mass-transfer-transaction.html)	| PaymentTransaction* |
| ------------- | ------------- | ------------- | ------------- |
| feeAssetId	| +	| +	| |
| amount	| +	|	 | + | 
| assetId	| +	| + |  | 
...
* `ExchangeTransaction` - the transaction from DEX [Matcher](https://docs.earths.ga/platform-features/decentralized-cryptocurrency-exchange-dex.html)
...
## Other
* `CreateAliasTransaction` - create a personal [Alias](https://docs.earths.ga/earths-client/account-management/creating-an-alias.html)
...
* DataTransaction -[Here](https://docs.earths.ga/technical-details/data-transaction.html) you can find more details about Data Transaction.
...
* SponsorFeeTransaction - [Here](https://docs.earths.ga/technical-details/sponsored-fee.html)  you can find more details aboutfee sponsorship.
   - `.assetId` - return an asset id as ByteVector
   - `.minSponsoredAssetFee` - return a minimal sponsored asset fee as Option[Long]
 
## Predefined functions

EarthsContracts standard library not only contains predefined data types and instances, but also predefined functions that can be called. Some of them are pure, others can access blockchain state.


* Native Earths context functions:
...
* User's Earths context functions
   - `addressFromPublicKey` : `ByteVector => addressType`
   - `addressFromString` : `String => UNION(addressType.typeRef, UNIT)`
   - `earthsBalance`: `addressOrAliasType => Long` - provide balance info for any account
 
* `DataTransaction`can set/overwrite a typed primitive value for a key on account of sender. These fields can be accessed from         EarthsContracts via:
